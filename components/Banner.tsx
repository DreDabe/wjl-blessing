...
const Banner: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 pointer-events-none">
      ...
      {/* Toggle Handle Button - similar to TopTimeBar */}
      <div className="absolute top-full left-1/2 -translate-x-1/2 pointer-events-auto">
        <button
          onClick={() => setIsExpanded(!isExpanded)}
          className="group flex items-center justify-center bg-gray-900/90 backdrop-blur-md border-b border-x border-white/10 rounded-b-xl px-12 py-1.5 cursor-pointer hover:bg-gray-900/100 transition-all shadow-lg"
