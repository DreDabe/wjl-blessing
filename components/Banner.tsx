...
const Banner: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      {/* Banner Wrapper - contains both content and toggle */}
      <div 
        className={`relative mx-auto max-w-2xl transition-all duration-500 ease-in-out transform ${isExpanded ? 'translate-y-0' : '-translate-y-full'}`}
      >
        {/* Main Banner Content */}
        ...
        {/* Toggle Handle Button - attached to banner bottom */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 pointer-events-auto -translate-y-1/2">
          <button
